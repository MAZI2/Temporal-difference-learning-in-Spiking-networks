...
mod_spikes = nest.Create("spike_generator", {"spike_times": [25.0, 150]})
...
for step in range(200):  # simulate 200 ms in 1 ms chunks
...
axs[1].set_ylabel("c_delayed")
axs[1].set_title("c_delayed over time")

# n trace
axs[2].plot(time_points, n_data, color='purple')
axs[2].set_ylabel("n")
axs[2].set_title("Neuromodulator n over time")
