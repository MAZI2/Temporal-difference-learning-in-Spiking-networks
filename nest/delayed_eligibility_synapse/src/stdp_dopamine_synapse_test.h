...
template < typename targetidentifierT >
void
stdp_dopamine_synapse_test< targetidentifierT >::get_status( Dictionary& d ) const
{
...
template < typename targetidentifierT >
void
stdp_dopamine_synapse_test< targetidentifierT >::set_status( const Dictionary& d, ConnectorModel& cm )
{
...
template < typename targetidentifierT >
void
stdp_dopamine_synapse_test< targetidentifierT >::check_synapse_params( const Dictionary& syn_spec ) const
{
