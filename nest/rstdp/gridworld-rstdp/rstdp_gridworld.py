...
class PongNet(ABC):
    def __init__(self, apply_noise=True, num_neurons=20):
        ...
        self.motor_neurons = nest.Create("iaf_psc_exp", 4)
        self.spike_recorders = nest.Create("spike_recorder", 4)
...
class PongNetRSTDP(PongNet):
    ...
    def __init__(self, apply_noise=True, num_neurons=20):
        ...
        if apply_noise:
            self.background_generator = nest.Create("noise_generator", 4, params={"std": BG_STD})
