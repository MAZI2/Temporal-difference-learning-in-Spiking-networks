...
Če je utež sinapse pozitivna bo membranski potencial glede na postsinaptični tok naraščal proti pragu proženja. Pravimo, da je taka povezava ekscitatorna. Obratno, če je utež sinapse negativna, bo membranski potencial padal. Taki povezavi pravimo inhibitorna povezava. Skupni tok $I_{\text{syn}}$, ki ga postsinaptični nevron prejme preko vseh sinaps je zato sestavljen iz excitatorne in inhibitorne komponente.
\[
...
Parametri so bili izbrani eksperimentalno brez oziranja na biološko točnost. Ob spreminjanju velikosti posameznih skupin nevronov moramo pri izbiri parametrov paziti na ohranjanje osnovne frekvence dopaminergičnih nevronov in da sta inhibicija in ekscitacija zaradi direktne in indirektne povezave v ravnovesju. Zmanjšanje frekvence, ki jo opravlja plast nevronov med vhodnimi in izhodnimi, mora biti dovolj velika, da bo pri osnovnih utežeh sinaps med srednjo plastjo in izhodnimi nevroni šum omogočil učenje, kot je to razloženo v poglavju \ref{sec:rstdp}.
...
%TODO: zakaj dipnejo uteži

\label{pic8}
\end{figure}
\newpage
\subsection{Rezultati}
Naučeno politiko bomo prikazali podobno kot v poglavju \ref{sec:rstdp}, vendar bomo ``samozavest'' izbire akcije v določenem stanju prikazali skupaj s povprečno utežjo povezav med vhodnimi nevroni pripadajočega stanja in striatumom.
\begin{figure}[H]
\begin{center}
...
\\
%TODO: rerun simulation and inspect the weights after 3000iters best. Look if you can answer why some policies are wrong and save the progress image.
%TODO: on the progress add mean steps/manhattan to get to goal. The graphs should correlate
\begin{figure}[H]
\begin{center}
...
\label{pic8}
\end{figure}
%TODO: preveri ce so vsi figures linked
