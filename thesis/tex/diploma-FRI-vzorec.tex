...
\begin{enumerate}
    ...
    Impulzne nevronske mreže so definirane tako z modelom nevrona kot z modelom sinapse, ki nevrone povezujejo. Modelov je sicer veliko, v nadaljeanju pa bodo predstavljeni "integrate and fire" 
...
\colorbox{Apricot}{%
  \parbox{0.9\linewidth}{%
    \textbf{
        Verjetno potrebno več uvoda. Tu morda lahko prikažemo še par osnovnih mehanizmov sinaps, na primer asociacije med nevroni, 
