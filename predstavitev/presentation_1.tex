...
\vspace{0.3cm}
\begin{itemize}
    \item \textbf{Problem:} kako izvajati spodbujevano učenje v impulznih nevronskih mrežah.
...
\begin{itemize}
    \item STDP je lokalno pravilo učenja, kjer se sinaptične uteži spreminjajo glede na relativni čas proženja pre- in postsinaptičnih nevronov.
        \vspace{0.3cm}
    ...
    \end{itemize}
    \vspace{0.3cm}
    \item Ne vključuje informacije o nagradi. Razširimo z dopaminsko modulacijo in kasneje s TD učenjem.

\end{itemize}
\begin{figure}
\includegraphics[width=0.6\linewidth]{figs/STDP.png}\\
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{figs/RSTDP.png}
\end{figure}
\end{frame}
...
\]
\begin{figure}
\includegraphics[width=0.6\linewidth]{figs/actor-critic.png}
\end{figure}
\end{frame}
...
\begin{itemize}
    ...
    \item Možna boljša izbira hiperparametrov.
